...
export function  ProfessionalCard(props: Props) {
  ...
  return (
   <>
    ...
    :
    <article className={`relative professional-card flex flex-col items-center w-88 h-132 rounded-2xl bg-[#f6f6f6] shadow-md hover:-translate-y-5 transition duration-200 overflow-hidden ${flipped ? 'rotate-y-180' : ''}`} onClick={flipCard}>
      <div className="relative flex flex-col items-center w-full h-full p-5">
        ...
        <main className="h-[36%] flex flex-col items-center">
        ...
        <footer className="h-[12%] w-full flex flex-col items-center justify-center gap-4">
